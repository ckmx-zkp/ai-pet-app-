...
## 当前状态：Epic A + B1 + B2.1 已完成（2026-08-02）
...
开发前确认 backend 用户 API 的**已部署**状态（看总看板“集成点状态”与 backend 进度摘要，不能只看本地代码）；auth、E1.1 devices、E2 persona、E4 messages 已部署。memories、analyses、peripheral 等仍以看板为准。
